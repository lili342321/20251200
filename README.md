...
- `cdeint_module.py`: The main script that executes the program.
- `gamma.py`: A folder containing utility functions.
- `rk_common.py`: Contains sample data or input files.
